-- Create time_standards table for USA Swimming Motivational Standards 2024-2028
-- This table stores official time standards by age group, gender, course type, and event
...
COMMENT ON TABLE time_standards IS 'USA Swimming Motivational Time Standards 2024-2028. Time values are stored in seconds as decimal numbers for consistent comparison.';
